...
from KristinaMusic.modules.play import generate_cover
from KristinaMusic.modules.play import arq
from KristinaMusic.modules.play import cb_admin_check
from KristinaMusic.modules.play import transcode
from KristinaMusic.modules.play import convert_seconds
from KristinaMusic.modules.play import time_to_seconds
from KristinaMusic.modules.play import changeImageSize
from KristinaMusic.config import BOT_NAME as bn
from KristinaMusic.config import DURATION_LIMIT
from KristinaMusic.config import UPDATES_CHANNEL as updateschannel
from KristinaMusic.config import que
from KristinaMusic.function.admins import admins as a
from KristinaMusic.helpers.errors import DurationLimitError
from KristinaMusic.helpers.decorators import errors
from KristinaMusic.helpers.admins import get_administrators
from KristinaMusic.helpers.channelmusic import get_chat_id
from KristinaMusic.helpers.decorators import authorized_users_only
from KristinaMusic.helpers.filters import command, other_filters
from KristinaMusic.helpers.gets import get_file_name
from KristinaMusic.services.callsmusic import callsmusic, queues
from KristinaMusic.services.callsmusic.callsmusic import client as USER
from KristinaMusic.services.converter.converter import convert
from KristinaMusic.services.downloaders import youtube
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @KristinaMusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
